...
<body onload="javascript:window.moveTo('-767','-1026');" style ="letter-spacing: -0.1em;">
       <!--[if lt IE 9]>
    ...
    <div class="wrap" style="position:absolute;top:0;left:0;right:0;width:764px;height:1024px;margin:0 auto;background:url(../img/deskPopup/ak_academy_05_bg.jpg) no-repeat 0 0;">
    </div><!-- //wrap -->
</body>
