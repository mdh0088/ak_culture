...
<body onload="javascript:setTimeout(function(){window.close()},5000);" style ="letter-spacing: -0.1em;">
       <!--[if lt IE 9]>
    ...
    <!-- 20190523 수정: 레이아웃 수정 -->
    <div class="loader v2 loading">
        <div class="loader-body">
            <div class="loader-document-02"></div>
            <div class="loader-text">
                <strong>수강신청이 완료되었습니다.</strong>
    ...
    <div class="wrap">
    <table style="position:absolute;top:0;left:0;right:0;margin:0 auto;background:url(../img/deskPopup/ak_academy_05_bg.jpg) no-repeat 0 0;">
            <div class="container">
