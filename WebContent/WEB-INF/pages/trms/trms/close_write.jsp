...
function getIt()
{
	$.ajax({
		...
		success : function(data) 
		{
			console.log(data);
			var result = JSON.parse(data);
			if(result.length > 0 && result[0].TOT_AMT != undefined && result[0].TOT_AMT != null)
			{
...
<div class="row view-page">
	<div class="wid-centW">
		<div class="white-bg">
			<h3 class="h3-tit">마감 등록</h3>
			<form id="fncForm" name="fncForm" method="POST" action="./close_proc">
				<div class="bor-div">
...
<!-- 					</div> -->
					...
					<div class="top-row tavle-input">
						<div class="wid-10">
							<div class="table">
								<div class="sear-tit">마감입금</div>
								<div>
									<input type="text" id="tot_amt" name="tot_amt" value="0" class="inp-82 text-right notEmpty comma" data-name="마감입금" placeholder="">
		...
		<div class="btn-wr text-center">
			...
			<a class="btn btn02 ok-btn" onclick="javascript:fncSubmit();">마감 등록/수정</a>
		</div>
