		...
		success : function(data) 
		{
			...
			if(result.list.length > 0)
			{
				for(var i = 0; i < result.list.length; i++)
				{
					...
					inner += '	<span class="td-350">'+result.list[i].MAIN_TITLE+'</span>';
					...
					inner += '	<span class="open"><a href="./list_upload?seq='+result.list[i].SEQ+'"><b>수정</b></a></span>';
					inner += '</li>';
				}
			}
			else
...
function setSort()
{
	for(var i = 0; i<document.getElementsByName('seqs').length; i++)
	{
		...
		$.ajax({
			...
			url : "./sortMBanner?sort="+i+"&seq="+seq,//호출 URL을 설정한다. GET방식일경우 뒤에 파라티터를 붙여서 사용해도된다.
...
function preview()
{
	...
	window.open("./preview_mbanner?seq="+chkList);
}
</script>
...
<div class="sub-tit">
	...
	<div class="btn-right">
		<A class="btn btn01 btn01_1" href="/web/list_upload"><i class="material-icons">add</i> 배너 등록 </A>
	</div>
</div>
...
<div class="table-cap table">
	...
	<div class="cap-r text-right">
		<div class="table float-right">
			<div class="sel-scr">
<!-- 				<a class="btn btn01" href="preview_main" target="_blank">화면 미리보기</a> -->
	...
	<div class="table-inner">
		...
		<ul class="ul9">
			<li class="table-th">
				...
				<span class="td-350">Main Title </span>
<!-- 				<span>크기 </span> -->
				<span>작성자 </span>
...
<!-- 			</li> -->
		...
		<p class="web-bcap">※ 모바일 배너는 1개씩만 노출 가능합니다. 출력여부 Y 체크 필수</p>
		
		
	</div>
	<br>
	<a class="btn btn01" onclick="javascript:delMBanner();">선택 삭제</a>
		...
		<table>
			<thead>
				<tr>
					...
					<th class="td-350">Main Title <img src="/img/th_down.png" /></th>
