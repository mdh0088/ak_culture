...
<div class="give-wrap">
				...
				<div class="gift-table">
					<div class="table-cap table">
						...
						<div class="cap-r text-right">
							<div><a class="bor-btn bor-btn02 btn03" href="#">검색회원 전체추가1</a></div>
			...
			<div class="wid-5 wid-5_gift">
				...
				<div class="gift-table gift-table02">
					<div class="table-cap table">
						...
						<div class="cap-r text-right">
							<div><a class="bor-btn bor-btn02 btn03" href="#">검색회원 전체추가2</a></div>
							<div class="sel-scr mrg-l6">
								<select id="listSize" name="listSize" onchange="reSelect()" de-data="10개 보기">
									<option value="20">10개 보기</option>
									<option value="20">20개 보기</option>
	...
	<div class="btn-wr text-center">
		...
		<a class="btn btn02 ok-btn" onclick="javascript:choose_cust();"><i class="material-icons">check</i>선택완료</a>
	</div>
	</form>
</div>